...
export default async function UserReportPage({
  ...
  params: Promise<{ login: string; runId: string; userLogin: string }>;
}) {
  const { login, runId, userLogin } = await params;
    ...
    <div className="container py-8 px-4">
      ...
      <div className="mb-8">
        <Button variant="ghost" size="sm" className="mb-4" asChild>
          <Link href={`/organizations/${login}/analysis/${runId}`}>
